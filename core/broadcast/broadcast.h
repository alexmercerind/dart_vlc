...
class Broadcast {
 ...
 const char* argumentos[10] = {"--dshow-fps=30", "--dshow-vdev=e2eSoft iVCam", "--dshow-adev=none", "--dshow-size=d1", "--dshow-aspect-ratio=21:9", "--live-caching=0", "--video-on-top", "--no-video-deco", "--video-x=1", "--video-y=1"};
