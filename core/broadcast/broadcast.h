...
class Broadcast {
 ...
 const char* argumentos[9] = {"--zoom=1.2", "--dshow-vdev=e2eSoft iVCam" "--dshow-adev=none", "--dshow-chroma=YUY2", "--live-caching=0", "--video-on-top", "--no-video-deco", "--video-x=200", "--video-y=100"};
