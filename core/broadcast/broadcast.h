...
class Broadcast {
 ...
 const char* argumentos[10] = {"--zoom=1.2", "--dshow-adev=none", "--dshow-size=1280x720", "--dshow-chroma=YUY2", "--dshow-aspect-ratio=16:9", "--live-caching=0", "--video-on-top", "--no-video-deco", "--video-x=200", "--video-y=100"};
