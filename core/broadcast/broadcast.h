...
class Broadcast {
 ...
 const char* argumentos[9] = {"--dshow-vdev=e2eSoft iVCam", "--dshow-adev=none", "--dshow-size=1280x720", "--dshow-aspect-ratio=16:9", "--live-caching=0", "--video-on-top", "--no-video-deco", "--video-x=1", "--video-y=1"};
