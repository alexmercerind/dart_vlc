...
class Broadcast {
 ...
 const char* argumentos[8] = {"--dshow-vdev=e2eSoft iVCam", "--dshow-adev=none", "--dshow-chroma=YUY2", "--live-caching=0", "--video-on-top", "--no-video-deco", "--zoom=0.8", "--sout-transcode-threads=8", "--video-x=200", "--video-y=100};
