...
class Broadcast {
 ...
 const char* argumentos[8] = {"--dshow-vdev=e2eSoft iVCam", "--dshow-adev=none", "--dshow-size=d1", "--dshow-aspect-ratio=16:9", "--live-caching=0", "--video-on-top", "--video-x=1", "--video-y=1"};
