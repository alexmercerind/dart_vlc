...
class Broadcast {
 ...
 const char* argumentos[9] = {"--dshow-fps=30", "--dshow-adev=none", "--dshow-size=1280x720", "--dshow-aspect-ratio=32:9", "--live-caching=0", "--video-on-top", "--no-video-deco", "--video-x=350", "--video-y=150"};
