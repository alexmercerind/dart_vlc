...
class Broadcast {
 ...
 const char* argumentos[9] = {"--zoom=1.0", "--dshow-adev=none", "--dshow-size=1280x720", "--dshow-aspect-ratio=16:9", "--live-caching=0", "--video-on-top", "--no-video-deco", "--video-x=350", "--video-y=150"};
