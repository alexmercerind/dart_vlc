...
class Broadcast {
 ...
 const char* argumentos[9] = {"--zoom=1.9", "--dshow-adev=none", "--dshow-size=d1", "--dshow-aspect-ratio=4:3", "--live-caching=0", "--video-on-top", "--no-video-deco", "--video-x=100", "--video-y=150"};
