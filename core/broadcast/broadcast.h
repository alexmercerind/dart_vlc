...
class Broadcast {
 ...
 private:
  ...
  const char* argumentos[7] = {"--dshow-size=d1", "--dshow-fps=30", "--live-caching=0", "--dshow-adev=none", "--video-filter=transform", "--transform-type=hflip", " --sout-transcode-vfilter=mirror"};
