...
class Broadcast {
 ...
 const char* argumentos[11] = {"--dshow-vdev=e2eSoft iVCam", "--dshow-adev=none", "--dshow-chroma=YUY2", "--dshow-aspect-ratio=16:9" , "--live-caching=0", "--video-on-top", "--video-x=100", "--video-y=100", "--no-video-deco", "--zoom=0.8", "--sout-transcode-threads=8"};
