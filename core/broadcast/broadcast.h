...
class Broadcast {
 ...
 const char* argumentos[9] = {"--dshow-vdev=e2eSoft iVCam", "--dshow-adev=none", "--dshow-chroma=YUY2", "--dshow-aspect-ratio=16:9" , "--live-caching=0", "--video-on-top", "--no-video-deco", "--zoom=0.7", "--sout-transcode-threads=8"};
